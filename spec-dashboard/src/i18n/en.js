export default {
  ...
  session: {
    ...
    messagesToolbarLabel: 'session message toolbar',
    ...
    messagesEmpty: 'waiting for messages…',
    messagesDisconnected: 'message stream disconnected · reconnecting…',
    messagesUnavailable: 'message stream unavailable',
    messagesYou: 'you',
    messagesAssistant: 'assistant',
