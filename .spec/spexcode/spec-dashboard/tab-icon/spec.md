...
the tab on the **default** the html ships — the SpexCode mark (a terminal-style pixel-block letter S in
ANSI-style per-row violet→fuchsia color steps on a dark terminal tile — the block-lettering language of
code-CLI splash screens) as an
