...
function renderNode(n: ProofNode): string {
  ...
  else if (n.hasYatsu) proof = `<div class="blindspot">declares scenarios but has no reading yet — measure with <code>spex eval add ${esc(n.id)}</code></div>`
...
<main class="proof">
  ...
  <footer>Generated by <code>spex eval ls --session ${esc(idShort)} --export</code> — the optimizer's measured loss, presented for the merge decision. A spec is the loss; commits are the optimizer; yatsu is the evaluation.</footer>
</main>
</body></html>`
}
