...
// is the SHARED TimelineChat ([[session-console]] mounts the same component for a headless session's Chat
// tab). What stays here is the phone chrome: the identity card with its back control, and the header's one
