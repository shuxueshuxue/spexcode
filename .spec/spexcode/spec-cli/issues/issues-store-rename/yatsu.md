...
scenarios:
  ...
  - name: concurrent-first-touch
    ...
    description: >-
      ...
      very first touch after the update (a burst of `spex propose`/`spex issues`).
    expected: >-
...
proof drives the same first-touch an updated deployment hits — a plain `spex issues`/`spex propose` — and
