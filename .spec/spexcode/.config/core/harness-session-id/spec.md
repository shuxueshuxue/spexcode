...
must be retained for later transport-level delivery.
...
`spex session harness-id`. The hook dispatcher stays a dumb manifest runner; payload divergence stays behind the
