...
fetched and writes nothing), so [[spec-yatsu]]'s measurement lint can later import `resolveEvalPending`
...
Out of scope (later/sibling): wiring `spex eval lint` to actually call this (a [[spec-yatsu]] concern),
