...
until `npm run hooks` / the 0.3.0 migrator heals it — visible degradation over silent wrong
behavior.
...
`codex-launch`/`codex-turn` — is namespaced under `spex internal`, absent from the map; its usage
